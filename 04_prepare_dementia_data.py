...
def prepare_dementia_data():
    ...
    data_files = {
        "dementia_data": os.path.join(project_dir, "Data", "DementiaSurveillanceData.csv"),
        "dementia_metadata": os.path.join(project_dir, "Data", "DementiaSurveillanceMetadata.csv"),
    }
    ...
    pcdem_data_path = os.path.join(project_dir, "Data", "pcdem-prac-data-date-mar-2024.csv")
